...
<body>
    ...
    <script>
      // Show/hide credit card field and update phone requirement based on user type
      ...
      // Basic client-side checks to match the PHP rules
